...
1 About 
2 Usage 
    2.1 Simple usage: auto_scrape 
    2.2 Scrape from a particular site: scrape_suite 
    2.3 Retrieving only certain fields 
    2.4 Calling the methods manually 
    2.5 Handling errors 
        2.5.1 BaseUrlLoadFailure 
        2.5.2 ParsingError 
        2.5.3 FieldNotFound 
        2.5.4 CantIdentifyUrl 
3 Adding more sites 
    3.1 Creating the methods 
        3.1.1 The decorators 
        3.1.2 Using shortmem to reduce redundancy 
    3.2 Creating and registering a suite 
...
fields in the dictionary).  Common fields are:
 ...
 [CantIdentifyUrl]: sec-2.1
 [Handling errors]: sec-2.1
